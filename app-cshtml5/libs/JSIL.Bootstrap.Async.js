...
JSIL.ImplementExternals("System.Threading.Tasks.TaskCompletionSource`1", function ($) {
  ...
  $.Method({ Static: false, Public: true }, "SetResult",
(new JSIL.MethodSignature(null, [new JSIL.GenericParameter("TResult", "System.Threading.Tasks.TaskCompletionSource`1")], [])),
function SetResult(result) {
    if (this.task.IsCompleted)
        throw new JSIL.ConstructorSignature($jsilcore.TypeRef("System.Exception"), [$jsilcore.TypeRef("System.String")]).Construct("TaskAlreadyCompleted");
