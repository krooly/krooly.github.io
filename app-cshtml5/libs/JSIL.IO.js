...
JSIL.ImplementExternals("System.IO.File", function ($) {
  ...
  (new JSIL.MethodSignature($jsilcore.TypeRef("System.IO.FileStream"), [$.String, $jsilcore.TypeRef("System.IO.FileMode")], [])),
    ...
    function Write (buffer, offset, count) {
        var newPosition = this._pos + count;
            ...
            if (newPosition > this._length) {
                ...
                var arrayForNewSize = new Uint8Array(this._length);
                arrayForNewSize.set(this._buffer);
                this._buffer = arrayForNewSize;
            }
...
JSIL.ImplementExternals("System.IO.IsolatedStorage.IsolatedStorageFile", function ($) {


    var $S00 = function () {
        return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($jsilcore.TypeRef("System.IO.FileInfo"), [$jsilcore.TypeRef("System.String")])))();
    };

    var $S01 = function () {
        return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($jsilcore.TypeRef("System.IO.IsolatedStorage.IsolatedStorageFileStream"), [$jsilcore.TypeRef("System.String"), $jsilcore.TypeRef("System.IO.FileMode")])))();
    };

    var $T02 = function () {
        return ($T02 = JSIL.Memoize($jsilcore.System.IO.FileMode))();
    };

    var $T03 = function () {
        return ($T03 = JSIL.Memoize($jsilcore.System.IO.IsolatedStorage.IsolatedStorageFileStream))();
    };
    ...
    function IsolatedStorageFile_CreateFile(path) {
        return $S01().Construct(path, $T02().Create);
        //var fileInfo = $S00().Construct(path);
        //if (!fileInfo['get_Exists']()) {
        //    var result = $T03().$Cast(fileInfo['Create']());
        //} else {
        //    result = $T03().$Cast(fileInfo['OpenRead']());
        //}
        //return result;
    };

    $.Method({ Static: false, Public: true }, "CreateFile",
      new JSIL.MethodSignature($jsilcore.TypeRef("System.IO.IsolatedStorage.IsolatedStorageFileStream"), [$.String]),
      IsolatedStorageFile_CreateFile
    );
    ...
    $.Method({ Static: false, Public: true }, "FileExists",
      ...
      function fileExists(path) {
          return ($S00().Construct(path))['get_Exists']();
      }
    );

    $.Method({ Static: true, Public: true }, "GetUserStoreForAssembly",
      JSIL.MethodSignature.Return($.Type),
      function getUserStoreForAssembly() {
          return new System.IO.IsolatedStorage.IsolatedStorageFile();
      }
    );
